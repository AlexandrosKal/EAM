                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <div class="input-group">
                     ...
                     <input id="fname" name="first_name" type="text" placeholder="Όνομα" class="form-control">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <div class="input-group">
                     ...
                     <input id="lname" name="last_name" type="text" placeholder="Επίθετο" class="form-control">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <div class="input-group">
                     ...
                     <input id="adt" name="id_num" type="text" placeholder="Αριθμός Δελτίου Ταυτότητας" class="form-control" maxlength="8" >
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-8">
                    <div class="input-group">
                     ...
                     <input id="bday" name="date_of_birth" type="text" placeholder="Ημερομηνία Γέννησης - HH/MM/EEEE" class="form-control">
                    </div>
                  </div>
                </div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<div class="input-group">
										 ...
										 <input id="streetNum" name="street_num" type="text" placeholder="Αριθμός Οδού" class="form-control" maxlength="4">
										</div>
									</div>
							</div>
